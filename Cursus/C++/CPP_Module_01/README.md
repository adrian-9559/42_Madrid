# CPP Module 01 — Programación Orientada a Objetos (POO)
...
Aprender los fundamentos de la POO en C++: diseño de clases, encapsulación, constructores, destructores, herencia y polimorfismo.

Temas principales

- Definición y diseño de clases.
- Constructores, destructores y el principio RAII.
- Copia, asignación y la regla de tres/cinco.
- Herencia simple y virtual, polimorfismo mediante funciones virtuales.
- Uso práctico de `std::string` y manejo básico de errores mediante excepciones.

Ejercicios típicos

- Implementar jerarquías de clases (por ejemplo, `Animal`, `Dog`, `Cat`).
- Clases con recursos (abrir/cerrar ficheros) para practicar RAII.

Cómo evaluar y ejecutar
...
- Implementa la gestión correcta de recursos (RAII).
- Evita copiar recursos sin control: define correctamente los operadores si es necesario.
- Documenta las invariantes de tus clases.
